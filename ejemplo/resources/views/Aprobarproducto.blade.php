...
<div class="card" style="background:#ffffffee;">
  ...
  <ol class="breadcrumb" style="background: rgba(68, 68, 71, 0);">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Aprobar Productos</li>
                      </ol>
  ...
  <hr>
  <button type="submit" class="btn btn-success btn-sm btn-block" value="Guardar">Buscar Pendientes</button>
