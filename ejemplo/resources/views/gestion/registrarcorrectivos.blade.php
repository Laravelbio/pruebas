...
<div class="card" style="background:#ffffffee;">
  ...
  <div class="card-body">
    ...
    <form action="{{ route('gestion.crearclientecorrectivos') }}" method ="POST">
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-md-6">   
                                        ...
                                        <div class="row form-group">  
                                          <div class="col-md-4"><label for="exampleInputEmail1" class="secondary">Documento Cliente</label></div>   
                                          <div class="col-md-4">     
